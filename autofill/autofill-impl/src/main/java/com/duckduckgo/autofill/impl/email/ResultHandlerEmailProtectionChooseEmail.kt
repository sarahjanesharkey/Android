...
class ResultHandlerEmailProtectionChooseEmail @Inject constructor(
    ...
    override fun processResult(
        ...
        when (userSelection) {
            UsePersonalEmailAddress -> onSelectedToUsePersonalAddress(autofillUrlRequest)
            UsePrivateAliasAddress -> onSelectedToUsePrivateAlias(autofillUrlRequest, tabId)
            DoNotUseEmailProtection -> onSelectedNotToUseEmailProtection(autofillUrlRequest)
        }
    }

    private fun onSelectedToUsePersonalAddress(autofillUrlRequest: AutofillUrlRequest) {
    ...
    private fun onSelectedNotToUseEmailProtection(autofillUrlRequest: AutofillUrlRequest) {
